...
* Instead of using a query string like @?locale=de@ it is possible to set the locale inside the path. For example _http://www.example.com/de_, _http://www.example.com/posts/123/comments/de_ Using this method should be prefered.
